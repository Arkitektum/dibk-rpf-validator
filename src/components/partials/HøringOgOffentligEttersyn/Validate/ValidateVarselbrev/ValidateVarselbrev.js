...
const VALIDATE_URL = process.env.REACT_APP_HOERING_OFFENTLIG_ETTERSYN_VALIDATE_URL;
const RULESET_API_URL = process.env.REACT_APP_HOERING_OFFENTLIG_ETTERSYN_RULES_URL;
   ...
   return (
      <Fragment>
         <div className="row mb-3">
            <div className="col">
               <RuleInfo apiUrl={RULESET_API_URL} rulesetName="Høring og offentlig ettersyn - Varselbrev" username={username} />
            </div>
         </div>
