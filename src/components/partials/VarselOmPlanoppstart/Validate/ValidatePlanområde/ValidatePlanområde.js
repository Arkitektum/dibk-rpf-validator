...
const VALIDATE_URL = process.env.REACT_APP_VARSEL_PLANOPPSTART_PLANOMRAADE_VALIDATE_URL;
const RULESET_API_URL = process.env.REACT_APP_VARSEL_PLANOPPSTART_PLANOMRAADE_RULES_URL;
   ...
   return (
      <Fragment>
         <div className="row mb-3">
            <div className="col">
               <RuleInfo apiUrl={RULESET_API_URL} rulesetName="Varsel om planoppstart - Planområde" username={username} />
            </div>
         </div>
